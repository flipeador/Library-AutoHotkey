...
CB1 := new ComboBoxEx(Gui, "w200 r10 Simple")
CB2 := new ComboBoxEx(Gui, "y+14 w" . (Gui.MarginX+2*CB1.Ctrl.Pos.W))
DDL := new ComboBoxEx(Gui, "x" . (2*Gui.MarginX+CB1.Ctrl.Pos.W) . " ys w" . CB1.Ctrl.Pos.W . " DDL")
...
{
    global CB1, DDL
    local Path := SubStr(DDL.Text, 1, 2)
