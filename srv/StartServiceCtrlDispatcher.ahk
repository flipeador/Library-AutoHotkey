/*
    ...
    Parámetros:
        ServiceName: El nombre de un servicio que se ejecutará en este proceso de servicio.
...
StartServiceCtrlDispatcher(ServiceName := '', ServiceProc := 'ServiceMain')
{
    ...
    NumPut(ServiceName is 'Integer' ? ServiceName : RegisterCallback(ServiceProc), &SERVICE_TABLE_ENTRY + A_PtrSize)
